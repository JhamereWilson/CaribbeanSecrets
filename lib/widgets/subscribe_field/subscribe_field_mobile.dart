...
class SubscribeFieldMobile extends StatefulWidget {
  @override
  _SubscribeFieldMobileState createState() => _SubscribeFieldMobileState();
}

class _SubscribeFieldMobileState extends State<SubscribeFieldMobile> {
